package com.platform.notification.health;
...
@Component("notificationDependencies")
public class NotificationDependenciesHealthIndicator extends AbstractTcpDependenciesHealthIndicator {

    private final Environment environment;

    public NotificationDependenciesHealthIndicator(Environment environment, TcpConnectivityChecker tcpConnectivityChecker) {
