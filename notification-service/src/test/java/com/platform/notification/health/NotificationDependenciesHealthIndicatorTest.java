...
class NotificationDependenciesHealthIndicatorTest {
    ...
    void healthShouldBeUpWhenMysqlAndRabbitMqAreReachable() {
        ...
        NotificationDependenciesHealthIndicator indicator = new NotificationDependenciesHealthIndicator(environment, checker);
