...
class ContentDependenciesHealthIndicatorTest {

    @Test
    void healthShouldBeUpWhenDependenciesAreReachable() {
        ...
        ContentDependenciesHealthIndicator indicator = new ContentDependenciesHealthIndicator(environment, checker);
