...
public interface ArticleService {
    ...
    List<ArticleReviewSnapshotDto> getPendingReviewSnapshots(long afterId, int limit);
    ReviewDecisionResultDto applyReviewResult(Long articleId, ApplyReviewResultReq req);
    ReviewDecisionResultDto getReviewDecisionResult(Long articleId, String decisionId);
