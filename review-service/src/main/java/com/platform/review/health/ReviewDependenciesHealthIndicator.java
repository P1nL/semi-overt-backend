...
@Component("reviewDependencies")
public class ReviewDependenciesHealthIndicator extends AbstractTcpDependenciesHealthIndicator {

    private final Environment environment;

    public ReviewDependenciesHealthIndicator(Environment environment, TcpConnectivityChecker tcpConnectivityChecker) {
