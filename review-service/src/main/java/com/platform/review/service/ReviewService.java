...
public interface ReviewService {
    ...
    ReviewActionResp doReview(Long articleId, Long currentAdminId, String idempotencyKey, ReviewActionReq req);
    ReviewDecisionStatusResp getDecisionStatus(Long articleId, Long currentAdminId, String decisionId);
